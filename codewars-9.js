...
console.log(tribonacci([13, 3, 4], 2));
console.log(tribonacci([8, 15, 10], 2));
// console.log(tribonacci([1, 1, 1], 10)); //,[1,1,1,3,5,9,17,31,57,105])
// console.log(tribonacci([0, 0, 1], 10)); //,[0,0,1,1,2,4,7,1,3,24,44])
...
// console.log(tribonacci([300, 200, 100], 0)); //,[])// console.log(tribonacci([0.5, 0.5, 0.5], 30));
